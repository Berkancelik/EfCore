...
using (var _context = new AppDbContext())
{
    ...
    var products = await _context.Products.AsNoTracking().FirstAsync(x => x.Id == 10);

    Console.WriteLine(_context.Entry(products).State);

    //var products = await _context.Products.Where(x => x.Id>10 && x.Name=="Kalem 10" || x.Stock>300).ToListAsync();
    //var products2 = await _context.Products.SingleAsync(x=> x.Id ==10);
    //var products3 = await _context.Products.FindAsync(10);
